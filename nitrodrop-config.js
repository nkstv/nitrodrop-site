...
// Modifie ces valeurs via admin.html (recommandé) ou directement ici.
// ===================================================================
...
const NITRODROP_DEFAULT_CONFIG = {
  ...
  ticker: [
    ...
    { name: "valen.tt", message: "+220€ sur Voltra" },
    { name: "ryu_odds", message: "+40€ de cashback sur Blazepit" },
    { name: "noa.reef", message: "+310€ sur Voltra" },
    { name: "mika_x", message: "+120€ sur Runeblock" }
  ],
  ...
  steps: {
    ...
    items: [
      { title: "Choisis une plateforme", desc: "Compare les bonus ci-dessus et clique sur \"J'en profite\" pour ouvrir l'inscription." },
      { title: "Colle le code", desc: "Renseigne le code correspondant dans le champ prévu au moment du dépôt." },
      { title: "Récupère ton bonus", desc: "Le montant est crédité automatiquement. Tu peux ensuite suivre ta position au classement." }
    ]
  },
...
function nitrodropLoadConfig() {
  try {
    ...
    // Fusion superficielle par section pour rester robuste si de nouveaux champs sont ajoutés plus tard
